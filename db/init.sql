...
INSERT INTO objets (nom, position, minZoomVisible, depart, typeObjet, id_debloquable, messageDebut, messageFin, url_image)
VALUES 
...
('oeufs', ST_GeomFromText('POINT(2.6459 49.2499)',4326), 9, FALSE, 'obj_recuperable', NULL, 'Bravo ! Tu es bien arrivé.e chez Garance. Elle te donne des oeufs de ses poules Bella et Ciao.', 'Direction la maison de mère-grand pour récupérer des framboises.', '/data/oeuf.jpg'),
('framboises', ST_GeomFromText('POINT(0.7506 45.1038)',4326), 9, FALSE, 'obj_bloque_par_code', 5, 'Mère-grand ne donne pas ses framboises à n''importe qui... Le code pour débloquer les framboises se trouve dans la demeure du premier ministre.', 'Des framboises en veux-tu en voilà ! Va chercher du sucre à la Khôlocscopie ! ', '/data/framboises.jpeg'),
('matignon', ST_GeomFromText('POINT(2.3207 48.8547)',4326), 9, FALSE, 'obj_code', NULL, 'Et voilà le code pour récupérer les framboises', 'Va retrouver mère-grand.', '/data/code_framboise.jpg'),
