...
('Code', ST_GeomFromText('POINT(2.3207 48.8547)',4326), 9, FALSE, 'obj_code', 1312, NULL, 'Et voilà le code pour récupérer les framboises', 'Va retrouver mère-grand.', '/data/code_framboise.jpg'),
('Sucre glace', ST_GeomFromText('POINT(2.5838 48.8459)',4326), 9, FALSE, 'obj_recuperable', NULL, NULL,'Les filles de la Khôloscopie te donnent du sucre glace !', 'Rends-toi maintenant à la mairie du fief de Louise Gouget.', '/data/sucre.jpg'),
