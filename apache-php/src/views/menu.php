...
<head>
    ...
    <!-- fichier pour gérer la Vue -->
    <script src="https://cdn.jsdelivr.net/npm/vue@3/dist/vue.global.js"></script>
    <!-- chemin fichier css du menu -->
...
<div id='app'>
    ...
    <h2 class='soustitre'>
    Un escape game créé par Nell Capelle et Clara Bouvier
    </h2>
    ...
    <div class='grosseboite'>
        ...
        <div class='classement'>
            <div class="fleche-coin" @click="scrollBas">
            ↓
            </div>
            <h3>
                Hall of fame
            </h3>
            <div class="scores-boite" ref="boiteScores" id="boiteScores">
    ...
    <div class="boitebouton">
        <!-- le bouton est lié à la méthode "commencerJeu" de la Vue qui gère le menu (menu.js)
        et va sur la route pour commencer à jouer -->
        <button @click="commencerJeu" class='bouton'>
        <b>C'est parti !</b>
        </button>
    </div>
...
<!-- lie le fichier js qui gère la Vue de la page menu -->
